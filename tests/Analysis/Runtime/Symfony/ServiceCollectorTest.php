...
use PhpDoctor\Analysis\Runtime\Symfony\ServiceCollector;
use PhpDoctor\Core\Finding\FindingBag;
use PhpDoctor\Core\Project\Framework;
use PhpDoctor\Core\Project\FrameworkContext;
use PHPUnit\Framework\TestCase;

final class ServiceCollectorTest extends TestCase
{
    ...
    public function testCollectsServicesFromFixtureJson(): void
    {
        $fixtureJson = file_get_contents(self::$fixtureRoot . '/fixture-container.json');
        ...
        $bag       = new FindingBag();
        $collector = new ServiceCollector($exec, $bag);
    ...
    public function testEmitsFindingOnCommandFailure(): void
    {
        ...
        $this->assertSame('runtime.symfony.services-unavailable', $findings[0]->ruleId);
    }
}
